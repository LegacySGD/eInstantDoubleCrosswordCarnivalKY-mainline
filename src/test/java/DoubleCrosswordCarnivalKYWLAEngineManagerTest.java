...
public class DoubleCrosswordCarnivalKYWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DoubleCrosswordCarnivalKYWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DualCrosswordCrazeKYIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DualCrosswordCrazeKYIW/InitOutcome.xml").getDocumentElement();
